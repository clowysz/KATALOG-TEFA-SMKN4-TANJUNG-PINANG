...
<section class="jurusan-hero-section" style="padding-top: 20px;">
    ...
    <div class="jurusan-hero-content">
        ...
        <div class="jurusan-hero-image">
            <img src="{{ asset('images/rpl-lab.jpeg') }}" alt="Siswa RPL Coding">
        </div>
        ...
        <div class="jurusan-hero-text">
            ...
            <p>Jurusan Rekayasa Perangkat Lunak (RPL) di SMKN 4 Tanjungpinang adalah program keahlian yang mempelajari cara merancang, membuat, menguji, dan merawat aplikasi atau program komputer.</p>
    ...
    <svg class="wave-jurusan" viewBox="0 0 1440 320" xmlns="http://www.w3.org/2000/svg">
        <path fill="#FFFFFF" fill-opacity="1" d="M0,128L48,144C96,160,192,192,288,186.7C384,181,480,139,576,144C672,149,768,203,864,213.3C960,224,1056,192,1152,176C1248,160,1344,160,1392,160L1440,160L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
    </svg>
</section>

<!-- KONTEN DESKRIPSI LENGKAP -->
<section class="deskripsi-content">
