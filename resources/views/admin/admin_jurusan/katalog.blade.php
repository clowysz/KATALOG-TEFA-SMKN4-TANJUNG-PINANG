...
<div style="background: white; padding: 12px 20px; border-radius: 12px; border: 1px solid #e2e8f0; display: flex; align-items: center; gap: 12px; margin-bottom: 30px; max-width: 500px; box-shadow: 0 1px 2px rgba(0,0,0,0.05);">
    ...
    <input type="text" id="searchKatalog" placeholder="Cari nama produk atau jasa..." style="border: none; outline: none; width: 100%; font-size: 14px; color: #334155; background: transparent;">
</div>

<div id="katalogLoading" style="background: white; border-radius: 16px; padding: 80px 20px; text-align: center; border: 1px dashed #cbd5e1;">
    <div style="font-size: 40px; margin-bottom: 12px;">⏳</div>
    <h3 style="color: #1e293b; font-size: 18px;">Memuat katalog...</h3>
</div>
...
<div id="katalogEmpty" style="display: none; background: white; border-radius: 16px; padding: 80px 20px; text-align: center; border: 1px dashed #cbd5e1;">
    ...
    <p style="color: #64748b; font-size: 14px; margin-bottom: 24px;">Belum ada produk atau jasa yang ditambahkan dari database.</p>
</div>
